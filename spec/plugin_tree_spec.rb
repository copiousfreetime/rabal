...
describe Rabal::PluginTree do
    before(:each) do 
        ...
        @tree        << PluginTree.new(resource_handle("builtin/core"))
    ...
    it "should allow for insertion into the Plugin Tree" do
        @tree << PluginTree.new(resource_handle("/builtin/test"),"test")
        @tree.process
    ...
    it "should allow for insertion into the Plugin Tree somewhere other than the root" do
        ...
        @tree.add_at_path("misc/stuff", PluginTree.new(resource_handle("/builtin/spec"),"spec"))

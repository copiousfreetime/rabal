...
describe "Utility functions" do
    before(:each) do
        @camel_before = %w(thisIsCamelCase ThisIsCamelCase IDoNotWantThis README)
        @camel_final = %w(ThisIsCamelCase ThisIsCamelCase IDoNotWantThis Readme)

        @dashed_before = %w(this-is-camel-case this-Is-camel-case i-do-nOt-want-this README)
        @dashed_final = %w(this-is-camel-case this-is-camel-case i-do-not-want-this README)
        
        @underscores_before = %w(this_is_Camel_Case this_is_caMel_case i_do_not_want_thiS README)
        @underscores_final = %w(this_is_camel_case this_is_camel_case i_do_not_want_this README)
    end
